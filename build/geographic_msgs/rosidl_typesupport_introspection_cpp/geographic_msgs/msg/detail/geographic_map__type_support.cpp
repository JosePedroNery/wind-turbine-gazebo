...
void fetch_function__GeographicMap__points(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geographic_msgs::msg::WayPoint *>(
    get_const_function__GeographicMap__points(untyped_member, index));
  auto & value = *reinterpret_cast<geographic_msgs::msg::WayPoint *>(untyped_value);
  value = item;
}

void assign_function__GeographicMap__points(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geographic_msgs::msg::WayPoint *>(
    get_function__GeographicMap__points(untyped_member, index));
  const auto & value = *reinterpret_cast<const geographic_msgs::msg::WayPoint *>(untyped_value);
  item = value;
}
...
void fetch_function__GeographicMap__features(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geographic_msgs::msg::MapFeature *>(
    get_const_function__GeographicMap__features(untyped_member, index));
  auto & value = *reinterpret_cast<geographic_msgs::msg::MapFeature *>(untyped_value);
  value = item;
}

void assign_function__GeographicMap__features(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geographic_msgs::msg::MapFeature *>(
    get_function__GeographicMap__features(untyped_member, index));
  const auto & value = *reinterpret_cast<const geographic_msgs::msg::MapFeature *>(untyped_value);
  item = value;
}
...
void fetch_function__GeographicMap__props(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geographic_msgs::msg::KeyValue *>(
    get_const_function__GeographicMap__props(untyped_member, index));
  auto & value = *reinterpret_cast<geographic_msgs::msg::KeyValue *>(untyped_value);
  value = item;
}

void assign_function__GeographicMap__props(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geographic_msgs::msg::KeyValue *>(
    get_function__GeographicMap__props(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GeographicMap_message_member_array[6] = {
  ...
  },
  {
    ...
    fetch_function__GeographicMap__points,  // fetch(index, &value) function pointer
    assign_function__GeographicMap__points,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__GeographicMap__features,  // fetch(index, &value) function pointer
    assign_function__GeographicMap__features,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__GeographicMap__props,  // fetch(index, &value) function pointer
    assign_function__GeographicMap__props,  // assign(index, value) function pointer
