...
#include "geographic_msgs/msg/detail/route_network__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const geographic_msgs::msg::RouteSegment &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const geographic_msgs::msg::RouteNetwork & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  geographic_msgs::msg::RouteNetwork & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_geographic_msgs
max_serialized_size_RouteNetwork(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: segments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        geographic_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RouteSegment(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = geographic_msgs::msg::RouteNetwork;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const geographic_msgs::msg::RouteNetwork *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<geographic_msgs::msg::RouteNetwork *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RouteNetwork__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const geographic_msgs::msg::RouteNetwork *>(
...
static size_t _RouteNetwork__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RouteNetwork(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RouteNetwork__callbacks = {
  "geographic_msgs::msg",
  "RouteNetwork",
...
static rosidl_message_type_support_t _RouteNetwork__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RouteNetwork__callbacks,
...
{
  return &geographic_msgs::msg::typesupport_fastrtps_cpp::_RouteNetwork__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, geographic_msgs, msg, RouteNetwork)() {
  return &geographic_msgs::msg::typesupport_fastrtps_cpp::_RouteNetwork__handle;
}
