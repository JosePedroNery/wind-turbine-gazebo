...
#include "geographic_msgs/msg/detail/map_feature__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const geographic_msgs::msg::MapFeature & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  geographic_msgs::msg::MapFeature & ros_message)
{
  // Member: id
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geographic_msgs::msg::MapFeature;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const geographic_msgs::msg::MapFeature *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<geographic_msgs::msg::MapFeature *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MapFeature__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const geographic_msgs::msg::MapFeature *>(
...
static size_t _MapFeature__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MapFeature(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MapFeature__callbacks = {
  "geographic_msgs::msg",
  "MapFeature",
...
static rosidl_message_type_support_t _MapFeature__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MapFeature__callbacks,
...
{
  return &geographic_msgs::msg::typesupport_fastrtps_cpp::_MapFeature__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, geographic_msgs, msg, MapFeature)() {
  return &geographic_msgs::msg::typesupport_fastrtps_cpp::_MapFeature__handle;
}
