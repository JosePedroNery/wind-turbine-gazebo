...
class Metaclass_GeoPoseWithCovariance(type):
    """Metaclass of message 'GeoPoseWithCovariance'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__geo_pose_with_covariance
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__geo_pose_with_covariance
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__geo_pose_with_covariance
            cls._TYPE_SUPPORT = module.type_support_msg__msg__geo_pose_with_covariance
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__geo_pose_with_covariance
...
class GeoPoseWithCovariance(metaclass=Metaclass_GeoPoseWithCovariance):
    """Message class 'GeoPoseWithCovariance'."""
    ...
    def __init__(self, **kwargs):
        ...
        from geographic_msgs.msg import GeoPose
        self.pose = kwargs.get('pose', GeoPose())
    ...
    def pose(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'pose' field must be a sub message of type 'GeoPose'"
        self._pose = value
