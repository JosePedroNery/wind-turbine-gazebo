...
#include "geographic_msgs/msg/detail/way_point__rosidl_typesupport_fastrtps_c.h"
...
using _WayPoint__ros_msg_type = geographic_msgs__msg__WayPoint;
...
static uint32_t _WayPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_geographic_msgs__msg__WayPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geographic_msgs__msg__WayPoint;
    is_plain =
      (
...
static size_t _WayPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_geographic_msgs__msg__WayPoint(
