...
class Metaclass_GeographicMap(type):
    """Metaclass of message 'GeographicMap'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__geographic_map
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__geographic_map
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__geographic_map
            cls._TYPE_SUPPORT = module.type_support_msg__msg__geographic_map
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__geographic_map
            ...
            if MapFeature.__class__._TYPE_SUPPORT is None:
                MapFeature.__class__.__import_type_support__()
...
class GeographicMap(metaclass=Metaclass_GeographicMap):
    """Message class 'GeographicMap'."""
    ...
    _fields_and_field_types = {
        ...
        'features': 'sequence<geographic_msgs/MapFeature>',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['geographic_msgs', 'msg'], 'MapFeature')),  # noqa: E501
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, str) and
                 not isinstance(value, UserString) and
                 all(isinstance(v, MapFeature) for v in value) and
                 True), \
                "The 'features' field must be a set or sequence and each value of type 'MapFeature'"
