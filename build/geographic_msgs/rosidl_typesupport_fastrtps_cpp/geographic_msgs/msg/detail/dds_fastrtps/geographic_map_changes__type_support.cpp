...
#include "geographic_msgs/msg/detail/geographic_map_changes__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const geographic_msgs::msg::GeographicMapChanges & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  geographic_msgs::msg::GeographicMapChanges & ros_message)
{
  // Member: header
  ...
  // Member: deletes
  {
    ...
    ros_message.deletes.resize(size);
    for (size_t i = 0; i < size; i++) {
      unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.deletes[i]);
    }
  }
  ...
  // Member: deletes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.deletes[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geographic_msgs::msg::GeographicMapChanges;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const geographic_msgs::msg::GeographicMapChanges *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<geographic_msgs::msg::GeographicMapChanges *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GeographicMapChanges__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const geographic_msgs::msg::GeographicMapChanges *>(
...
static size_t _GeographicMapChanges__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GeographicMapChanges(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GeographicMapChanges__callbacks = {
  "geographic_msgs::msg",
...
static rosidl_message_type_support_t _GeographicMapChanges__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GeographicMapChanges__callbacks,
...
{
  return &geographic_msgs::msg::typesupport_fastrtps_cpp::_GeographicMapChanges__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, geographic_msgs, msg, GeographicMapChanges)() {
  return &geographic_msgs::msg::typesupport_fastrtps_cpp::_GeographicMapChanges__handle;
}
