...
#include "geographic_msgs/msg/detail/geo_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const geographic_msgs::msg::GeoPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  geographic_msgs::msg::GeoPose & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geographic_msgs::msg::GeoPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const geographic_msgs::msg::GeoPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<geographic_msgs::msg::GeoPose *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GeoPose__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const geographic_msgs::msg::GeoPose *>(
...
static size_t _GeoPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GeoPose(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GeoPose__callbacks = {
  "geographic_msgs::msg",
  "GeoPose",
...
static rosidl_message_type_support_t _GeoPose__handle = {
...
{
  return &geographic_msgs::msg::typesupport_fastrtps_cpp::_GeoPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, geographic_msgs, msg, GeoPose)() {
  return &geographic_msgs::msg::typesupport_fastrtps_cpp::_GeoPose__handle;
}
