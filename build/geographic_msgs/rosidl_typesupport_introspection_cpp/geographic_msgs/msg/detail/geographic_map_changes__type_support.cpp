...
void fetch_function__GeographicMapChanges__deletes(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const unique_identifier_msgs::msg::UUID *>(
    get_const_function__GeographicMapChanges__deletes(untyped_member, index));
  auto & value = *reinterpret_cast<unique_identifier_msgs::msg::UUID *>(untyped_value);
  value = item;
}

void assign_function__GeographicMapChanges__deletes(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<unique_identifier_msgs::msg::UUID *>(
    get_function__GeographicMapChanges__deletes(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GeographicMapChanges_message_member_array[3] = {
  ...
  },
  {
    ...
    fetch_function__GeographicMapChanges__deletes,  // fetch(index, &value) function pointer
    assign_function__GeographicMapChanges__deletes,  // assign(index, value) function pointer
