...
void fetch_function__RouteNetwork__segments(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geographic_msgs::msg::RouteSegment *>(
    get_const_function__RouteNetwork__segments(untyped_member, index));
  auto & value = *reinterpret_cast<geographic_msgs::msg::RouteSegment *>(untyped_value);
  value = item;
}

void assign_function__RouteNetwork__segments(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geographic_msgs::msg::RouteSegment *>(
    get_function__RouteNetwork__segments(untyped_member, index));
  const auto & value = *reinterpret_cast<const geographic_msgs::msg::RouteSegment *>(untyped_value);
  item = value;
}
...
void fetch_function__RouteNetwork__props(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geographic_msgs::msg::KeyValue *>(
    get_const_function__RouteNetwork__props(untyped_member, index));
  auto & value = *reinterpret_cast<geographic_msgs::msg::KeyValue *>(untyped_value);
  value = item;
}

void assign_function__RouteNetwork__props(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geographic_msgs::msg::KeyValue *>(
    get_function__RouteNetwork__props(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RouteNetwork_message_member_array[6] = {
  ...
  },
  {
    ...
    fetch_function__RouteNetwork__points,  // fetch(index, &value) function pointer
    assign_function__RouteNetwork__points,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__RouteNetwork__segments,  // fetch(index, &value) function pointer
    assign_function__RouteNetwork__segments,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__RouteNetwork__props,  // fetch(index, &value) function pointer
    assign_function__RouteNetwork__props,  // assign(index, value) function pointer
