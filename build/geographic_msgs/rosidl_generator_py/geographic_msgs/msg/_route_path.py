...
class Metaclass_RoutePath(type):
    """Metaclass of message 'RoutePath'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__route_path
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__route_path
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__route_path
            cls._TYPE_SUPPORT = module.type_support_msg__msg__route_path
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__route_path
...
class RoutePath(metaclass=Metaclass_RoutePath):
    """Message class 'RoutePath'."""
    ...
    _fields_and_field_types = {
        ...
        'segments': 'sequence<unique_identifier_msgs/UUID>',
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'segments' field must be a set or sequence and each value of type 'UUID'"
