...
#include "geographic_msgs/msg/detail/route_path__rosidl_typesupport_fastrtps_c.h"
...
#include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // network, segments
...
using _RoutePath__ros_msg_type = geographic_msgs__msg__RoutePath;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RoutePath__ros_msg_type * ros_message = static_cast<const _RoutePath__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RoutePath__ros_msg_type * ros_message = static_cast<_RoutePath__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: segments
  {
    ...
    if (ros_message->segments.data) {
      unique_identifier_msgs__msg__UUID__Sequence__fini(&ros_message->segments);
    }
    if (!unique_identifier_msgs__msg__UUID__Sequence__init(&ros_message->segments, size)) {
...
static uint32_t _RoutePath__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_geographic_msgs__msg__RoutePath(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geographic_msgs__msg__RoutePath;
    is_plain =
      (
...
static size_t _RoutePath__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_geographic_msgs__msg__RoutePath(
...
static message_type_support_callbacks_t __callbacks_RoutePath = {
  "geographic_msgs::msg",
  "RoutePath",
